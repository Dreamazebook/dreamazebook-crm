...
const CouponsPagination: FC<CouponsPaginationProps> = ({
  totalItems,
  currentPage,
  setCurrentPage,
  itemsPerPage,
        ...
        <div>
          <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px">
            ...
            {currentPage !== 1 && currentPage !== totalPages && (
              <button className="relative inline-flex items-center px-4 py-2 border border-gray-300 bg-blue-50 border-blue-500 text-blue-600 text-sm font-medium">
                {currentPage}
              </button>
            )}
